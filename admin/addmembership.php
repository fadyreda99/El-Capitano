...
if (isset($_SESSION['admin'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (empty($errors)) {
            $memberObject->insert(
                "(Start_Date_Of_Membership, End_Date_Of_Membership, Cost_Of_Membership, DriverID) VALUES (?,?,?,?)",
                array($startdate, $enddate, $cost, $driverid)
            );
            $theMsg = '<div class="container"><div class="alert alert-success"> record has Added </div> </div>';
    ...
    <div class="container">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
            ...
            <div class="col-12 form-control-lg">
                ...
                <input type="date" class="form-control " name="startdate" autocomplete="off" Type Of Car>
                <div class="valid-feedback">
                    Looks good!
                </div>
                <div class="invalid-feedback">
                    Please enter Start Date Of Membership.
                </div>
            </div>

            <div class="col-12 form-control-lg">
                <label for="validationCustom01" class="form-label ">End Date Of Membership</label>
                <input type="date" class="form-control " name="enddate" autocomplete="off" Type Of Car>
                <div class="valid-feedback">
                    Looks good!
                </div>
                <div class="invalid-feedback">
                    Please enter End Date Of Membership.
                </div>
            </div>
            <div class="col-12 form-control-lg">
                <label for="validationCustom01" class="form-label ">Cost Of Membership</label>
                <input type="text" class="form-control " name="cost" autocomplete="off" Type Of Car>
                <div class="valid-feedback">
                    Looks good!
                </div>
                <div class="invalid-feedback">
                    Please enter Cost Of Membership.
                </div>
            </div>
