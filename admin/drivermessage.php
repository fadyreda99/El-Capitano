...
?>
        ...
        <h1 class="text-center edit">driver messages</h1>
        <div class="container ">
                    ...
                    <tbody>
                        <?php foreach ($contacs as $contact) {  ?>
                            <tr>
                                ...
                                <td class="">
                                    <a href="drivermessage.php?do=delete&messageid=<?php echo $contact['Message_ID'] ?>" class="btn btn-danger confirm"> <i class="fa fa-close"></i>Delete</a>
                                    <a href="drivermessage.php?do=view&messageid=<?php echo $contact['Message_ID'] ?>" class="btn btn-primary "> view</a>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="card shadow mt-3 mb-5 ">
                                        ...
                                        <div class="card-footer">
                                            <a href="drivers.php?do=view&driverid=<?php echo $contact['userid'] ?>" class="btn btn-primary">view profile</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
